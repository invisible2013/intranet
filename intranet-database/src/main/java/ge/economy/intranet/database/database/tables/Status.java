...
public class Status extends TableImpl<StatusRecord> {
	...
	private static final long serialVersionUID = 1405120503;
	 ...
	 */
	public final TableField<StatusRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>public.status.name</code>.
	 */
	public final TableField<StatusRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR, this, "");
