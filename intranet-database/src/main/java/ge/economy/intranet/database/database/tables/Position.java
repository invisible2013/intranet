...
public class Position extends TableImpl<PositionRecord> {
	...
	private static final long serialVersionUID = 724705010;
	 ...
	 */
	public final TableField<PositionRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");
	...
	/**
	 * The column <code>public.position.position</code>.
	 */
	public final TableField<PositionRecord, String> POSITION_ = createField("position", org.jooq.impl.SQLDataType.VARCHAR, this, "");

	/**
	 * The column <code>public.position.ldap_key</code>.
	 */
	public final TableField<PositionRecord, String> LDAP_KEY = createField("ldap_key", org.jooq.impl.SQLDataType.VARCHAR, this, "");
